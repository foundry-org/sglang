...
class Engine(EngineScoreMixin, EngineBase):
    ...
    def _launch_scheduler_processes(
        ...
        *,
        ...
        """Launch scheduler (or DP controller) processes.

        Override in subclasses for different backends (e.g. Ray). The
        implementation lives in `worker_launch` so that `prespawn` can start
        the workers before this module (and its import graph) is loaded.
        """
    ...
    def _launch_subprocesses(
        ...
        # argument parsing, before this module was imported): adopt them and
